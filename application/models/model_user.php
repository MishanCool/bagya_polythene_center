	...
	class model_user extends CI_Model{
		...
		function insert_user_data()
		{
			...
			$data = array(
				...
				'password' => sha1($this->input->post('password',TRUE)),   /* sha1 algorithem eka danne password eka nodanna string eka kata convert karanna */
		...
		function login_user()
		{
			...
			*/
			...
			$password = sha1($this->input->post('password'));   /* sha1 algorithem eka danne password eka nodanna string eka kata convert karanna */
